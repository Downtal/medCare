        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                 ...
                 <CardContent className="p-6">
                    ...
                    <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-50">
                       <div className="flex items-start gap-4">
                          ...
                          <div>
                             <p className="text-sm text-blue-600 font-bold mb-1">Dự kiến nhận hàng</p>
                             <h2 className="text-xl font-black text-slate-900 mb-2">
                                {order.status === 'DELIVERED' ? 'Giao hàng thành công' : 'Đang trong quá trình xử lý'}
                             </h2>
                             <p className="text-sm text-slate-500 font-medium">
                                {order.status === 'DELIVERED' 
                                  ? 'Rất vui vì bạn đã tin tưởng và mua hàng tại MedCare.' 
                                  : 'Hệ thống đang chuẩn bị sản phẩm và giao đến bạn trong thời gian sớm nhất.'}
                             </p>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mt-8">
                       ...
                       <div className="space-y-4">
                          ...
                          <div className="pl-6">
                             ...
                             <p className="text-blue-600 text-xs font-bold mt-2 flex items-center gap-1 cursor-pointer hover:underline">
            ...
            <div className="space-y-6">
              ...
              {/* Promo Banner Style */}
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-6 text-white relative overflow-hidden group cursor-pointer shadow-lg">
                 ...
                 <h4 className="text-lg font-black leading-tight mb-2 relative z-10">FREESHIP<br />MỌI ĐƠN HÀNG</h4>
                 <p className="text-xs text-white/80 relative z-10 font-bold uppercase tracking-widest">Dành riêng cho bạn</p>
              </div>
            </div>
          </div>
        </div>
