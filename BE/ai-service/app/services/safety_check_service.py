...
class SafetyCheckService:
    ...
    async def check_drug_safety(self, user_id: Optional[int], cart_items: List[Dict]) -> Dict:
        ...
        try:
            ...
            return {
                "risk_level": "NONE",
                "message": "Hệ thống tự động đã kiểm tra cơ bản dựa trên danh mục thuốc. Tuy nhiên, để đảm bảo an toàn tuyệt đối, vui lòng đọc kỹ hướng dẫn sử dụng hoặc tham vấn dược sĩ chuyên môn.",
