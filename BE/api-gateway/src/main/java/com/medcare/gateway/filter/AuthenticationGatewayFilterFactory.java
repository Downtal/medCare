...
public class AuthenticationGatewayFilterFactory
    ...
    private boolean isPublicPath(String path) {
        return path.startsWith("/auth-service/api/auth/login")
                ...
                || path.startsWith("/auth-service/api/auth/verify-otp")
                || path.startsWith("/auth-service/api/auth/reset-password")
                || path.startsWith("/auth-service/api/auth/verify-registration")
                || path.startsWith("/auth-service/api/auth/resend-verification-otp")
